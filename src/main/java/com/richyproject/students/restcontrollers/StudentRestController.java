package com.richyproject.students.restcontrollers;
...
public class StudentRestController {
    ...
    Server's fault = the problem is in your backend code, not the user's request.

    Examples of 5xx (server errors):

    Your code has a bug and crashes
    Database connection fails
    Null pointer exception
    Out of memory

    vs 4xx (client errors):
