...
The application includes full CRUD functionality — students can add (including uploading photos), update, and delete their profiles — strong Spring Security protocols including custom authentication and role-based access control to restrict sensitive operations as well as oauth2 login for google and github. Student profile images and data are stored using AWS, with the project deployed on an AWS EC2 instance.
